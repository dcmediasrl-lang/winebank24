...
export default async function PrivacyPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      <header className="bg-stone-950 text-white px-8 py-4 flex items-center justify-between">
        <Link href={`/${lang}`} className="flex items-center gap-2">
          <Wine className="w-5 h-5 text-amber-400" />
          <span className="font-bold">Wine Bank 24</span>
        </Link>
        <Link href={lang === "en" ? "/it/privacy" : "/en/privacy"} className="text-stone-500 text-xs hover:text-amber-400">
          {lang === "en" ? "🇮🇹 IT" : "🇬🇧 EN"}
        </Link>
      </header>
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="mb-10">
          <h1 className="text-3xl font-bold text-stone-900 mb-2">{en ? "Privacy Policy" : "Privacy Policy"}</h1>
          <p className="text-stone-500 text-sm">{en ? "Last updated: May 2026 — Pursuant to EU Regulation 2016/679 (GDPR)" : "Ultimo aggiornamento: maggio 2026 — Ai sensi del Regolamento UE 2016/679 (GDPR)"}</p>
        </div>
        <div className="space-y-10 text-stone-700 leading-relaxed">
          {en ? (
            <>
              <section>
                <h2 className="text-xl font-bold text-stone-900 mb-3">1. Data Controller</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-stone-900 mb-3">2. Data Collected</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-stone-900 mb-3">3. Purpose of Processing</h2>
                <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              ...
              <section>
                <h2 className="text-xl font-bold text-stone-900 mb-3">4. Legal Basis</h2>
                <ul className="mt-2 space-y-1 text-sm list-disc list-inside">
              ...
              <section>
                <h2 className="text-xl font-bold text-stone-900 mb-3">5. Data Retention</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-stone-900 mb-3">6. Data Sharing</h2>
              ...
              <section>
                <h2 className="text-xl font-bold text-stone-900 mb-3">8. Cookies</h2>
            ...
            <>
              ...
              <section>
                <h2 className="text-xl font-bold text-stone-900 mb-3">5. Conservazione</h2>
                <p>Dati account conservati per la durata del contratto + 10 anni (obblighi fiscali). Dati di navigazione max 12 mesi.</p>
              </section>
              <section>
                <h2 className="text-xl font-bold text-stone-900 mb-3">6. Condivisione</h2>
